...
<div class="wpdevart_plugins_header div-for-clear">
	...
	<a target="blank" href="<?php echo wpdevart_contactform_support_url; ?>" class="wpdevart_support">Have any Questions? Get quick support!</a>
</div>
<header class="header">
    <div class="main-bar">
        <div class="col-sm-5">
            <div class="logo"><a href="http://wpdevart.com/" target="_blank"><img src=<?php echo wpda_form_PLUGIN_URI . "assets/images/logo.png"; ?> alt="wpdevart Forms"></a></div>
        </div>
        <div class="col-sm-7">
